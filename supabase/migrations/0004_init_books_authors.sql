...
--> statement-breakpoint
ALTER TABLE "book_meet" ADD CONSTRAINT "fk_book_id_books_id" FOREIGN KEY ("fk_book_id") REFERENCES "public"."books"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "book_meet" ADD CONSTRAINT "fk_meet_id_meets_id" FOREIGN KEY ("fk_meet_id") REFERENCES "public"."meets"("id") ON DELETE no action ON UPDATE no action;