<script lang="ts">
	...
	let {
		...
		SVGAttributes<SVGElement> & { color?: 'light' | 'dark'; shape?: 'rd' | 'sq'; size?: number },
		SVGElement
	> = $props();
</script>
...
>
	{#if shape === 'rd'}
		...
		{/if}
	{:else if color === 'dark'}
		<rect x="0.5" y="0.5" width="39" height="39" rx="3.5" fill="#131314" />
		<g clip-path="url(#clip0_710_6225)">
			{@render paths()}
		</g>
		<rect x="0.5" y="0.5" width="39" height="39" rx="3.5" stroke="#8E918F" />
		<defs>
